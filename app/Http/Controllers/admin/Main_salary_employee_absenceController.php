        ...
        try {
            if ($request->ajax()) {
                ...
                if (!empty($financeMonth_data) and !empty($mainSalaryEmployee_data) and !empty($mainSalaryabsence_data)) {
                    ...
                    update(new Main_salary_employee_absence(), $dataToUpdate, array('com_code' => $com_code, 'id' => $request->id, 'finance_months_periods_id' => $request->finance_month_period_id, 'main_salary_employee_id' => $request->main_salary_employee_id, 'is_archived' => 0));
                    DB::commit();
        ...
        try {
            if ($request->ajax()) {
                ...
                if (!empty($financeMonth_data) and !empty($mainSalaryabsence_data) and !empty($mainSalaryEmployee_data)) {
                    ...
                    destroy(new Main_salary_employee_absence(), array('com_code' => $com_code, 'id' => $request->id, 'finance_months_periods_id' => $request->finance_month_period_id, 'is_archived' => 0));
