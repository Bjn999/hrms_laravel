    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center">
                تعديل نوع مكافئة المالية للراتب
            </h3>
        </div>
        <div class="card-body">
            <form action="{{ route('additionalsaltypes.update', $data['id']) }}" method="post">
                @csrf
                ...
                <div class="col-md-12">
                    <div class="form-group text-center">
                        ...
                        <a href=" {{ route('additionalsaltypes.index') }} " class="btn btn-danger">إلغاء</a>
                    </div>
                </div>
            </form>
        </div>
