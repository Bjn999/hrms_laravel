                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            ...
                            <a href="{{ route('additionalsaltypes.edit', $info->id) }}" class="btn btn-success">تعديل</a>
                            <a href="{{ route('additionalsaltypes.destroy', $info->id) }}" class="btn btn-danger r_u_sure">حذف</a>
