...
<head>
    ...
    <title> بحث بالسلف المستديمة للرواتب</title>
...
<body style="padding-top: 20px; font-family: tahoma;">
    ...
    <table dir="rtl" id="example2" class="table table-bordered table-hover" style="width: 98%;margin: 0 auto;">
        <thead style="background-color: lightblue">
            ...
            <th style="vertical-align: middle; width: 10%"> تاريخ بدأ السداد </th>
            <th style="vertical-align: middle; width: 10%"> اجمالي التاريخ </th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="vertical-align: middle"> {{ $info->year_and_month_start_date }} </td>
