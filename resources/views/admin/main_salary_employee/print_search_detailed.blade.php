                        ...
                        <td style="text-align:left !important; padding: 5px;">
                            <div style="text-align: center;">
                                <img style="width: 90px; height: 90px; border-radius: 10px;"
                                    src="{{ url('assets/admin/uploads') . '/' . $systemData['image'] }}"
                                    alt="company_logo">
                                <br />
                                <br />
            ...
            <div class="card-body">
                ...
                <table dir="rtl" cellspacing="1" cellpadding="3" border="2"
                    ...
                    <tr>
                        ...
                        <td>{{ $info->emp_name }} (الكود: {{ $info->employee_code }})</td>
                    </tr>
                    <tr>
                        <td style="width: 20%"> الوظيفة</td>
                        <td colspan="2">{{ $info->job }} </td>
                    </tr>
                    {{-- @if ($info['last_salary_remain_blance'] < 0) --}}
                    <tr style="background-color: lightblue">
                        <td colspan="3"> ملحوظة الرصيد المرحل من الشهر السابق
                            {{ $info['last_salary_remain_blance'] * 1 }} رس</td>
                    </tr>
                    {{-- @endif --}}
                    <tr>
                ...
                <table dir="rtl" cellspacing="1" cellpadding="3" border="2"
                    ...
                    <tr>
                        ...
                        <td style=" background-color: lightgray !important; ;">{{ $info['emp_sal'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td colspan="2">مكافئة مالية</td>
                        <td>{{ $info['reward'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td colspan="2">حافز الثابت</td>
                        <td>{{ $info['motivation'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td rowspan="2"> بدلات </td>
                        <td>بدلات ثابتة </td>
                        <td>{{ $info['fixed_allowances'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td> بدلات متغيرة </td>
                        <td>{{ $info['changable_allowances'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td colspan="2"> اضافي الايام </td>
                        <td>
                            @if ($info['additional_days_counter'] > 0)
                                {{ $info['additional_days_total'] * 1 }} رس <br />
                                عدد الايام : ({{ $info['additional_days_counter'] * 1 }})
                            @else
                                0 رس
                            @endif
                        </td>
                    ...
                    <tr style=" background-color: lightgreen !important;">
                        ...
                        <td>{{ $info['total_benefits'] * 1 }} رس</td>
                    </tr>
                </table>
                ...
                <table dir="rtl" cellspacing="1" cellpadding="3" border="2"
                    style="text-align:right;border-color: black; width: 97%;  margin: 0 auto;">
                    <tr>
                        {{-- <td rowspan=@if (!empty($info['main_salary_employee_discount'])) "{{ count($info['main_salary_employee_discount']) + 12 }}" @else "{{ 12 }}" @endif --}}
                        <td rowspan="9" style="width: 10%;-webkit-transform: rotate(-90deg)!important;"> الاستقطاعات
                        </td>
                        <td colspan="2"> تأمين اجتماعي </td>
                        <td> {{ $info['socialinsurancecutmonthly'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 50%"> تأمين طبي </td>
                        <td> {{ $info['medicalinsurancecutmonthly'] * 1 }} رس</td>
                    </tr>
                    <tr>
                        <td colspan="2"> الغياب</td>
                        <td>
                            {{-- {{ $info['absence_days_counter'] * 1 }}  --}}
                            @if ($info['absence_days_counter'] > 0)
                                {{ $info['absence_days_total'] * 1 }} رس <br />
                                عدد الايام : ({{ $info['absence_days_counter'] * 1 }})
                            @else
                                0 رس
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($info['sanctions_days_counter'] > 0)
                                {{ $info['sanctions_days_total'] * 1 }} رس <br />
                                عدد الايام : ({{ $info['sanctions_days_counter'] * 1 }})
                            @else
                                0 رس
                            @endif
                        </td>
