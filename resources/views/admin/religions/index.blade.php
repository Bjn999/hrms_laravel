        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> 
                    بيانات الديانات 
                    <a href=" {{ route('religions.create') }} " class="btn btn-sm btn-success">إضافة جديد</a>
                </h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                ...
                                <a href="{{ route('religions.edit', $info->id) }}" class="btn btn-success">تعديل</a>
                                <a href="{{ route('religions.destroy', $info->id) }}" class="btn btn-danger r_u_sure">حذف</a>
