        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center"> 
                    بيانات إدارات الموظفين 
                    <a href=" {{ route('departments.create') }} " class="btn btn-sm btn-success">إضافة جديد</a>
                </h3>
            </div>
            <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover text-center">
                    <thead class="custom_thead">
                        <tr>
                            <th style="vertical-align: middle"> اسم الإدارة </th>
                            <th style="vertical-align: middle"> هاتف الإدارة </th>
                            <th style="vertical-align: middle"> الملاحظات </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle"> {{ $info->notes }} </td>
                            ...
                            <td style="vertical-align: middle">
                                ...
                                <a href="{{ route('departments.edit', $info->id) }}" class="btn btn-success">تعديل</a>
                                <a href="{{ route('departments.destroy', $info->id) }}" class="btn btn-danger r_u_sure">حذف</a>
