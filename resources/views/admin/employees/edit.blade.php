                        ...
                        <div class="tab-content" id="custom-content-above-tabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autofocus name="emp_name" id="emp_name" class="form-control" value="{{ old('emp_name', $data['emp_name']) }}">
                                            @error('emp_name')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_gender" class="form-control" id="emp_gender">
                                                ...
                                                <option {{ old('emp_gender', $data['emp_gender']) == 1 ? 'selected' : '' }} value="1">ذكر</option>
                                                <option {{ old('emp_gender', $data['emp_gender']) == 2 ? 'selected' : '' }} value="2">أنثى</option>
                                            </select>
                                            @error('emp_gender')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="branch_id" id="branch_id" class="form-control select2">
                                                ...
                                                <option {{ old('branch_id', $data['branch_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('branch_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="qualifications_id" id="qualifications_id" class="form-control select2">
                                                ...
                                                <option {{ old('qualifications_id', $data['qualifications_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="graduation_estimate" class="form-control" id="graduation_estimate">
                                                <option {{ old('graduation_estimate', $data['graduation_estimate']) == 1 ? 'selected' : '' }} value="1">مقبول</option>
                                                <option {{ old('graduation_estimate', $data['graduation_estimate']) == 2 ? 'selected' : '' }} value="2">جيد</option>
                                                <option {{ old('graduation_estimate', $data['graduation_estimate']) == 3 ? 'selected' : '' }} value="3">جيد مرتفع</option>
                                                <option {{ old('graduation_estimate', $data['graduation_estimate']) == 4 ? 'selected' : '' }} value="4">جيد جداً</option>
                                                <option {{ old('graduation_estimate', $data['graduation_estimate']) == 5 ? 'selected' : '' }} value="5">إمتياز</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="emp_birth_date" id="emp_birth_date" class="form-control" value="{{ old('emp_birth_date', $data['emp_birth_date']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emp_national_identity" id="emp_national_identity" class="form-control" value="{{ old('emp_national_identity', $data['emp_national_identity']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="emp_end_identity_date" id="emp_end_identity_date" class="form-control" value="{{ old('emp_end_identity_date', $data['emp_end_identity_date']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emp_identity_place" id="emp_identity_place" class="form-control" value="{{ old('emp_identity_place', $data['emp_identity_place']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="blood_group_id" id="blood_group_id" class="form-control select2">
                                                ...
                                                <option {{ old('blood_group_id', $data['blood_group_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_nationality_id" id="emp_nationality_id" class="form-control select2">
                                                ...
                                                <option {{ old('emp_nationality_id', $data['emp_nationality_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_lang_id" id="emp_lang_id" class="form-control select2">
                                                ...
                                                <option {{ old('emp_lang_id', $data['emp_lang_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('emp_lang_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_social_status_id" id="emp_social_status_id" class="form-control select2">
                                                ...
                                                <option {{ old('emp_social_status_id', $data['emp_social_status_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_emp_social_status" @if(old('emp_social_status_id', $data['emp_social_status_id'])==1 || old('emp_social_status_id', $data['emp_social_status_id'])=='' ) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="children_number">عدد الأبناء:</label>
                                            <input type="text" name="children_number" id="children_number" class="form-control" value="{{ old('children_number', $data['children_number']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="religion_id" id="religion_id" class="form-control select2">
                                                ...
                                                <option {{ old('religion_id', $data['religion_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('religion_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="country_id" id="country_id" class="form-control select2">
                                                ...
                                                <option {{ old('country_id', $data['country_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('country_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="governorate_DIV">
                                            ...
                                            <select name="governorate_id" id="governorate_id" class="form-control select2">
                                                ...
                                                <option {{ old('governorate_id', $data['governorate_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="city_DIV">
                                            ...
                                            <select name="city_id" id="city_id" class="form-control select2">
                                                ...
                                                <option {{ old('city_id', $data['city_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('city_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_military_id" id="emp_military_id" class="form-control select2">
                                                ...
                                                <option {{ old('emp_military_id', $data['emp_military_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4 related_military_1" @if (old('emp_military_id', $data['emp_military_id']) !=1) style="display:none" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 related_military_1" @if (old('emp_military_id', $data['emp_military_id']) !=1) style="display:none" @endif>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emp_military_weapon" id="emp_military_weapon" class="form-control" value="{{ old('emp_military_weapon', $data['emp_military_weapon']) }}">
                                            @error('emp_military_weapon')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4 related_military_2" @if (old('emp_military_id', $data['emp_military_id']) !=2) style="display:none" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 related_military_3" @if (old('emp_military_id', $data['emp_military_id']) !=3) style="display:none" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="does_has_driving_license" class="form-control" id="does_has_driving_license">
                                                <option {{ old('does_has_driving_license', $data['does_has_driving_license']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                                <option {{ old('does_has_driving_license', $data['does_has_driving_license']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_driving_license" @if (old('does_has_driving_license', $data['does_has_driving_license']) !=1) style="display:none" @endif>
                                        <div class="form-group">
                                            <label for="driving_license_num">رقم رخصة القيادة: <span class="text-danger">*</span></label>
                                            <input type="text" name="driving_license_num" id="driving_license_num" class="form-control" value="{{ old('driving_license_num', $data['driving_license_num']) }}">
                                    ...
                                    <div class="col-md-4 related_to_driving_license" @if (old('does_has_driving_license', $data['does_has_driving_license']) !=1) style="display:none" @endif>
                                        <div class="form-group">
                                            ...
                                            <select name="driving_license_type_id" id="driving_license_type_id" class="form-control select2">
                                                ...
                                                <option {{ old('driving_license_type_id', $data['driving_license_type_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_relatives" class="form-control" id="has_relatives">
                                                <option {{ old('has_relatives', $data['has_relatives']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                                <option {{ old('has_relatives', $data['has_relatives']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                            </select>
                                            @error('has_relatives')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                    ...
                                    <div class="col-md-12 related_to_has_relatives" @if (old('has_relatives', $data['has_relatives']) !=1) style="display:none" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_disabilities_processes" class="form-control" id="is_disabilities_processes">
                                                <option {{ old('is_disabilities_processes', $data['is_disabilities_processes']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                                <option {{ old('is_disabilities_processes', $data['is_disabilities_processes']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 related_to_disabilities_processes" @if (old('is_disabilities_processes', $data['is_disabilities_processes']) !=1) style="display:none" @endif>
                                        <div class="form-group">
                                            <label for="disabilities_processes">تفاصيل الإعاقة / العملية سابقة: <span class="text-danger">*</span></label>
                                            <textarea type="text" name="disabilities_processes" id="disabilities_processes" class="form-control">{{ old('disabilities_processes', $data['disabilities_processes']) }}</textarea>
                            ...
                            <div class="tab-pane fade" id="job_data" role="tabpanel" aria-labelledby="custom-content-above-profile-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="functional_status" class="form-control" id="functional_status">
                                                <option selected value=""> غير محدد</option>
                                                <option {{ old('functional_status', $data['functional_status']) == 1 ? 'selected' : '' }} value="1">في الخدمة</option>
                                                <option {{ old('functional_status', $data['functional_status']) == 0 && old('functional_status', $data['functional_status']) != "" ? 'selected' : '' }} value="0">خارج الخدمة</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_departments_id" id="emp_departments_id" class="form-control select2">
                                                ...
                                                <option {{ old('emp_departments_id', $data['emp_departments_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="emp_job_id" id="emp_job_id" class="form-control select2">
                                                ...
                                                <option {{ old('emp_job_id', $data['emp_job_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('emp_job_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="does_has_attendance" class="form-control" id="does_has_attendance">
                                                <option {{ old('does_has_attendance', $data['does_has_attendance']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('does_has_attendance', $data['does_has_attendance']) == 0 and old('does_has_attendance', $data['does_has_attendance']) != "" ? 'selected' : '' }} value="0">لا</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_has_fixed_shift" class="form-control" id="is_has_fixed_shift">
                                                ...
                                                <option {{ old('is_has_fixed_shift', $data['is_has_fixed_shift']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('is_has_fixed_shift', $data['is_has_fixed_shift']) == 0 && old('is_has_fixed_shift', $data['is_has_fixed_shift']) != "" ? 'selected' : '' }} value="0">لا</option>
                                                {{-- <option @if(old('is_has_fixed_shift', $data['is_has_fixed_shift']) == 0) selected @endif value="0">لا</option> --}}
                                            </select>
                                    ...
                                    {{-- <div class="col-md-4 related_to_fixed_shifts_1" @if(old('is_has_fixed_shift') == 0 or old('is_has_fixed_shift') == "") style="display:none;" @endif> --}}
                                    <div class="col-md-4 related_to_fixed_shifts_1" @if(old('is_has_fixed_shift', $data['is_has_fixed_shift']) !=1) style="display:none;" @endif>
                                        <div class="form-group">
                                            ...
                                            <select name="shift_type_id" id="shift_type_id" class="form-control select2">
                                                ...
                                                <option {{ old('shift_type_id', $data['shift_type_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">
                                    ...
                                    {{-- <div class="col-md-4 related_to_fixed_shifts_0" @if(old('is_has_fixed_shift', $data['is_has_fixed_shift']) != 0) style="display:none;" @endif> --}}
                                    <div class="col-md-4 related_to_fixed_shifts_0" @if(old('is_has_fixed_shift', $data['is_has_fixed_shift'])==1 or old('is_has_fixed_shift', $data['is_has_fixed_shift'])=="" ) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="daily_work_hour">عدد الساعات اليومية:</label>
                                            <input type="trxt" name="daily_work_hour" id="daily_work_hour" class="form-control" value="{{ old('daily_work_hour', $data['daily_work_hour']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emp_sal" id="emp_sal" class="form-control" value="{{ old('emp_sal', $data['emp_sal']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            @error('emp_sal')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="day_price" id="day_price" class="form-control" value="{{ old('day_price', $data['day_price']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            @error('day_price')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="sal_cash_or_visa" class="form-control" id="sal_cash_or_visa">
                                                <option value="">غير محدد</option>
                                                <option {{ old('sal_cash_or_visa', $data['sal_cash_or_visa']) == 1 ? 'selected' : '' }} value="1">نقداً</option>
                                                <option {{ old('sal_cash_or_visa', $data['sal_cash_or_visa']) == 2 ? 'selected' : '' }} value="2">بنك/فيزا</option>
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_sal_cash_or_visa" @if(old('sal_cash_or_visa', $data['sal_cash_or_visa']) !=2) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="bank_number_account">رقم الفيزا/الحساب البنكي للموظف: <span class="text-danger">*</span></label>
                                            <input type="text" name="bank_number_account" id="bank_number_account" class="form-control" value="{{ old('bank_number_account', $data['bank_number_account']) }}" oninput="this.value = this.value.replace(/[^0-9]/g,'')">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="motivation_type" class="form-control" id="motivation_type">
                                                <option {{ old('motivation_type', $data['motivation_type']) == 0 and old('motivation_type') != "" ? 'selected' : '' }} value="0">لا يوجد</option>
                                                <option {{ old('motivation_type', $data['motivation_type']) == 1 ? 'selected' : '' }} value="1">ثابت</option>
                                                <option {{ old('motivation_type', $data['motivation_type']) == 2 ? 'selected' : '' }} value="2">متغير</option>
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_motivation_type_1" @if(old('motivation_type', $data['motivation_type']) !=1) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="motivation">قيمة الحافز: <span class="text-danger">*</span></label>
                                            <input type="text" name="motivation" id="motivation" class="form-control" value="{{ old('motivation', $data['motivation']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                            @error('motivation')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_social_insurance" class="form-control" id="is_social_insurance">
                                                <option {{ old('is_social_insurance', $data['is_social_insurance']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('is_social_insurance', $data['is_social_insurance']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_is_social_insurance" @if(old('is_social_insurance', $data['is_social_insurance']) !=1) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="social_insurance_number">رقم التأمين الإجتماعي: <span class="text-danger">*</span></label>
                                            <input type="text" name="social_insurance_number" id="social_insurance_number" class="form-control" value="{{ old('social_insurance_number', $data['social_insurance_number']) }}">
                                    ...
                                    <div class="col-md-4 related_to_is_social_insurance" @if(old('is_social_insurance', $data['is_social_insurance']) !=1) style="display:none;" @endif>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="social_insurance_cut_monthly" id="social_insurance_cut_monthly" class="form-control" value="{{ old('social_insurance_cut_monthly', $data['social_insurance_cut_monthly']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_medical_insurance" class="form-control" id="is_medical_insurance">
                                                <option {{ old('is_medical_insurance', $data['is_medical_insurance']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('is_medical_insurance', $data['is_medical_insurance']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_is_medical_insurance" @if(old('is_medical_insurance', $data['is_medical_insurance']) !=1) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="medical_insurance_number">رقم التأمين الطبي: <span class="text-danger">*</span></label>
                                            <input type="text" name="medical_insurance_number" id="medical_insurance_number" class="form-control" value="{{ old('medical_insurance_number', $data['medical_insurance_number']) }}">
                                    ...
                                    <div class="col-md-4 related_to_is_medical_insurance" @if(old('is_medical_insurance', $data['is_medical_insurance']) !=1) style="display:none;" @endif>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="medical_insurance_cut_monthly" id="medical_insurance_cut_monthly" class="form-control" value="{{ old('medical_insurance_cut_monthly', $data['medical_insurance_cut_monthly']) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active_for_vaccation" class="form-control" id="is_active_for_vaccation">
                                                <option {{ old('is_active_for_vaccation', $data['is_active_for_vaccation']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('is_active_for_vaccation', $data['is_active_for_vaccation']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" max-line="3" name="urgent_person_details" id="urgent_person_details" class="form-control">{{ old('urgent_person_details', $data['urgent_person_details']) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emp_pasport_place" id="emp_pasport_place" class="form-control" value="{{ old('emp_pasport_place', $data['emp_pasport_place']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="emp_passport_exp" id="emp_passport_exp" class="form-control" value="{{ old('emp_passport_exp', $data['emp_passport_exp']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="home_address" id="home_address" class="form-control" value="{{ old('home_address', $data['home_address']) }}">
                                            @error('home_address')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="resignation_id" id="resignation_id" class="form-control select2">
                                                ...
                                                <option {{ old('resignation_id', $data['resignation_id']) == $info->id ? 'selected' : '' }} value="{{ $info->id }}">{{ $info->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-4 related_to_resignation" @if(old('resignation_id', $data['resignation_id'])=="" ) style="display:none;" @endif>
                                        <div class="form-group">
                                            <label for="resignation_date">تاريخ ترك العمل:</label>
                                            <input type="date" name="resignation_date" id="resignation_date" class="form-control" value="{{ old('resignation_date', $data['resignation_date']) }}">
                                    ...
                                    <div class="col-md-4 related_to_resignation" @if(old('resignation_id', $data['resignation_id'])=="" ) style="display:none;" @endif>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="resignation_cause" id="resignation_cause" class="form-control" value="{{ old('resignation_cause', $data['resignation_cause']) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="does_has_fixed_allowance" class="form-control" id="does_has_fixed_allowance">
                                                <option {{ old('does_has_fixed_allowance', $data['does_has_fixed_allowance']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('does_has_fixed_allowance', $data['does_has_fixed_allowance']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="is_sensitive_manager_data" class="form-control" id="is_sensitive_manager_data">
                                                <option {{ old('is_sensitive_manager_data', $data['is_sensitive_manager_data']) == 1 ? 'selected' : '' }} value="1">نعم</option>
                                                <option {{ old('is_sensitive_manager_data', $data['is_sensitive_manager_data']) == 0 ? 'selected' : '' }} value="0">لا</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            @if (file_exists('assets/admin/uploads/'.$data['emp_photo']))
                                            <img class="emp_logo rounded-circle" src="{{ url('assets/admin/uploads').'/'.$data['emp_photo'] }}">
                                            @else
                                            <span class="text-danger mx-3"> صورة غير موجودة </span>
                                            @endif
                                            @else
                                            @if ($data['emp_gender'] == 1)
                                            <img class="emp_logo rounded-circle mx-3" src="{{ url('assets/admin/imgs/default_m.png') }}">
                                            @else
                                            <img class="emp_logo rounded-circle mx-3" src="{{ url('assets/admin/imgs/default_f.png') }}">
                                            @endif
                                            @endif
